...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    roleAr: "تصميم + تطوير متكامل",
    summary:
      "Upload a PDF, paste a job post, get an ATS-ready CV in the employer's own language.",
    summaryAr:
      "ارفع ملفك، الصق إعلان الوظيفة، واحصل على سيرة ذاتية بلغة جهة العمل جاهزة لأنظمة الفرز.",

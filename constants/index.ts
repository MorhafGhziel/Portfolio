...
export const PROJECTS: Project[] = [
...

  {
    ...
    year: "2024",
    role: "Frontend",
    roleAr: "واجهات أمامية",
    summary: "Headless Shopify storefront with a live cart and fast search.",
    summaryAr: "متجر Shopify بواجهة مستقلة مع سلة فورية وبحث سريع.",
  ...
  },
  {
    ...
    role: "Design + Build",
    roleAr: "تصميم + بناء",
    summary: "An earlier personal portfolio built on the Next.js App Router.",
    summaryAr: "محفظة شخصية سابقة مبنية على Next.js App Router.",
  ...
  },
  {
    ...
    role: "Frontend",
    roleAr: "واجهات أمامية",
    summary: "Reusable responsive component library for shipping UI fast.",
    summaryAr: "مكتبة مكونات متجاوبة قابلة لإعادة الاستخدام لبناء الواجهات بسرعة.",
  ...
  },
  {
    ...
    slug: "iphone-showcase",
    kind: "practice",
    year: "2023",
    role: "Frontend",
    roleAr: "واجهات أمامية",
    summary: "Scroll-driven Apple-style landing page with interactive 3D models.",
    summaryAr: "صفحة هبوط بأسلوب آبل مدفوعة بالتمرير مع نماذج ثلاثية الأبعاد تفاعلية.",
  ...
  },
  {
    ...
    role: "Frontend",
    roleAr: "واجهات أمامية",
    summary: "Landing page for an AI startup with animated, scroll-aware sections.",
    summaryAr: "صفحة هبوط لشركة ذكاء اصطناعي ناشئة بأقسام متحركة تتفاعل مع التمرير.",
  ...
  },
  {
    ...
    role: "Frontend",
    roleAr: "واجهات أمامية",
    summary: "SaaS landing page built around a single clear conversion path.",
    summaryAr: "صفحة هبوط لمنتج SaaS مبنية حول مسار تحويل واحد واضح.",
    ...
    liveUrl: "https://saa-s-nextjs-project.vercel.app/",
  },
] as const;
